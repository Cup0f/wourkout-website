...
import { getWorkoutDay, updateWorkoutDay } from "../../services/workoutDayStore";
...
export default function WorkoutDayEdit() {
    const { id } = useParams();
    ...
    return (
        <div className="p-4 text-slate-900 dark:text-white">
            <div className="mb-4 flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
                <div>
                    <h1 className="text-2xl font-extrabold">Edzésnap szerkesztése</h1>
                    <p className="mt-1 text-sm text-slate-500 dark:text-slate-400">
                        Módosítsd az edzésnap adatait és a gyakorlatok sorrendjét.
                    </p>
                </div>
                ...
                <div className="space-y-4">
                    <div className="rounded-2xl border border-slate-200 bg-white p-4 dark:border-white/10 dark:bg-slate-900">
                        ...
                        <div className="mt-4 flex flex-col gap-2 sm:flex-row">
                            <button
                                type="button"
                                onClick={() => navigate(`/workouts/days/${id}`)}
                                className="rounded-xl border border-slate-200 px-4 py-2 text-sm font-extrabold hover:bg-slate-50 dark:border-white/10 dark:hover:bg-white/5"
                            >
                                Mégse
                            </button>
                    ...
                    <div className="rounded-2xl border border-slate-200 bg-white p-4 dark:border-white/10 dark:bg-slate-900">
                        <div className="mb-2 text-sm font-extrabold">Megjegyzés</div>
                        <div className="text-sm text-slate-600 dark:text-slate-300">
                            A már meglévő gyakorlatok státusza megmarad. Az újonnan hozzáadott gyakorlatok
                            alapból <strong>Elvégzendő</strong> státusszal kerülnek be.
                        </div>
                    </div>
                </div>
            </form>
